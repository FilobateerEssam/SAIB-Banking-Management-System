<%@page import="java.util.* ,com.Bank.Registeration.*"%>
...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">SAIB BANK</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#portfolio">Offers</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#about">Transactions</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="#contact">Contact</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="Logout">Logout</a></li>
					<li class="nav-item mx-0 mx-lg-1 bg-danger"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="Logout"><%= session.getAttribute("full_name") %></a></li>
					<li class="nav-item mx-0 mx-lg-1 bg-danger"><div
						class="nav-link py-3 px-0 px-lg-3 rounded"  style="color: white;" ><%= session.getAttribute("account") %> </div></li>
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="images/Saib.png" style="width: 350px; height: 300px"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To SAIB BANK</h1>
	...
	<section class="page-section portfolio" id="portfolio">
		<div class="container" >
			...
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0">List Of Offers</h2>
			<!-- Icon Divider-->
			...
			<div class="row justify-content-center">
				...
				<div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="images/77.jpg"
							alt="..." />
					</div>
				</div>
				...
				<div class="col-md-6 col-lg-4 mb-5 mb-md-0">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="images/0.jpg"
							alt="..." />
					</div>
				</div>
				...
				<div class="col-md-6 col-lg-4">
					<div class="portfolio-item mx-auto" data-bs-toggle="modal"
						...
						<img class="img-fluid" src="images/88.jpg"
							alt="..." />
					</div>
				</div>
			</div>
...
<div class="container">
 	...
 	List <Transfers> transfers = 
 						(List<Transfers>) request.getAttribute("TRANSACTION_LIST");
 
 %>
 	 <% 
 
 	List <Client> clients = 
 						(List<Client>) request.getAttribute("TheClints");
 ...
 <div id="wrapper">
	...
	<div id="container">
		...
		<div id="content">
			...
			<input type="button" value="Make Deposite" 
				   onclick="window.location.href='add-Transaction-form.jsp'; return false;"
				   class="btn btn-success"
			/>
			...
			<table class="table table-bordered">
				...
				<tr>
				 ...
				 <c:forEach var="tempClient" items="${TRANSACTION_LIST}">
					 	<tr> 
					 		
					 		<td> ${tempClient.account } </td>
					 		<td> ${tempClient.num_Operation } </td>
					 		<td> ${tempClient.account_Receiver } </td>
					 		<td> ${tempClient.amount_Send } </td>
					 		<td> ${tempClient.date_Send } </td>
